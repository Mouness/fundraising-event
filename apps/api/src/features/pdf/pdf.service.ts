            ...
            content: [
...

                {
                    ...
                    table: {
                        widths: ['*', '*'],
                        body: [
                            [{ text: 'Organization Details', style: 'tableHeader' }, { text: 'Donation Details', style: 'tableHeader' }],
                            [
                                {
                                    text: [
                                ...
                                {
                                    text: [
                                        { text: 'Date: ', bold: true }, formattedDate, '\n',
                                        { text: 'Receipt #: ', bold: true }, data.transactionId.substring(0, 8).toUpperCase(), '\n',
                                        { text: 'Amount: ', bold: true }, `$${(data.amount / 100).toFixed(2)}`,
                                    ],
                                    margin: [0, 10, 0, 10]
                                }
                            ]
                ...
                { text: 'Donor Information', style: 'sectionHeader', margin: [0, 0, 0, 10] },
                {
                    text: [
                        { text: 'Name: ', bold: true }, data.donorName, '\n',
                    ],
                    margin: [0, 0, 0, 20]
                },
