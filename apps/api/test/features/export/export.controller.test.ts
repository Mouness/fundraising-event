...
describe('ExportController', () => {
    ...
    describe('downloadAllReceipts', () => {
        ...
        it('should use "global" filename if no eventId provided', async () => {
            ...
            await controller.downloadAllReceipts(mockResponse as unknown as Response, undefined)
    ...
    describe('downloadSingleReceipt', () => {
        it('should download receipt if found', async () => {
            ...
            await controller.downloadSingleReceipt('don_1', mockResponse as unknown as Response)
