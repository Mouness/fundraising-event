        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">{t('dashboard.stats.total_revenue')}</CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-xs" style={{ color: 'var(--admin-muted-text)' }}>{DASHBOARD_STATS.totalRevenue.change} {DASHBOARD_STATS.totalRevenue.period}</p>
                </CardContent>
            </Card>
            <Card
                style={{
            ...
            >
                ...
                <CardContent>
                    ...
                    <p className="text-xs" style={{ color: 'var(--admin-muted-text)' }}>{DASHBOARD_STATS.activeEvents.change} {DASHBOARD_STATS.activeEvents.period}</p>
                </CardContent>
            </Card>
            <Card
                style={{
            ...
            >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">{t('dashboard.stats.donations')}</CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-xs" style={{ color: 'var(--admin-muted-text)' }}>{DASHBOARD_STATS.donations.change} {DASHBOARD_STATS.donations.period}</p>
                </CardContent>
            </Card>
            <Card
                style={{
            ...
            >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">{t('dashboard.stats.staff_members')}</CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-xs" style={{ color: 'var(--admin-muted-text)' }}>{DASHBOARD_STATS.staffMembers.change} {DASHBOARD_STATS.staffMembers.period}</p>
                </CardContent>
            </Card>
        </div>
    );
