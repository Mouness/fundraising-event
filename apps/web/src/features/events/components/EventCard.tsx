...
export const EventCard = ({ event, variant = 'default' }: EventCardProps) => {
    ...
    return (
        <Card
            className="flex flex-col hover:shadow-md transition-shadow h-full"
            style={{
        ...
        >
            <CardHeader>
                <div className="flex justify-between items-start gap-4">
                    ...
                    <span
                        ...
                        style={{
                            backgroundColor:
                                status === 'ACTIVE' ? 'var(--global-success-bg)' : 'var(--muted)',
                            color:
                                status === 'ACTIVE'
                                    ? 'var(--global-success-color)'
            ...
            <CardContent className="flex-1 space-y-4">
                <div
                    className={`grid ${variant === 'compact' ? 'grid-cols-1' : 'grid-cols-2'} gap-4`}
                >
