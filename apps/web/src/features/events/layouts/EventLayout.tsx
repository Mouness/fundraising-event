        ...
        >
            <div className="mb-6">
                ...
                >
                    ...
                    {t('admin_events.back_to_events', 'Back to Events')}
                </Link>
                <div className="px-2">
                    <h1 className="text-lg font-bold truncate" title={event.name}>
                        {event.name}
                    </h1>
                    <p className="text-xs text-muted-foreground truncate">
                        {t('admin_events.event_console', 'Event Console')}
                    </p>
                </div>
            </div>
            ...
            <nav className="flex flex-col gap-1 flex-1">
                ...
                <Link
                    to={`${baseUrl}/settings`}
                    className={`p-2 rounded flex items-center gap-3 transition-colors ${
                        isActive(`${baseUrl}/settings`) && !isActive(`${baseUrl}/settings/design`)
                            ? 'bg-primary/10 text-primary font-medium'
                            : 'hover:bg-muted/10'
                    }`}
                >
