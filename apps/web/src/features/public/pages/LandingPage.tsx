            ...
            <div className="flex-grow flex flex-col items-center justify-center p-4 relative">
                ...
                <div className="w-full max-w-4xl flex flex-col items-center text-center gap-8 animate-in fade-in zoom-in duration-700 slide-in-from-bottom-8">
                    <div className="space-y-4">
                        <h2
                            className="text-5xl md:text-7xl font-black tracking-tighter text-balance leading-tight"
                            style={{ color: 'hsl(var(--landing-hero-text, inherit))' }}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md pt-8">
                        <Link to={`/${slug}/donate`} className="w-full">
                            <Button
                                size="lg"
                                className="w-full text-lg gap-3 h-14 shadow-xl shadow-primary/20 hover:scale-105 transition-all duration-300"
                                style={{
                        ...
                        <Link to={`/${slug}/live`} className="w-full">
                            <Button
                                size="lg"
                                variant="outline"
                                className="w-full text-lg gap-3 h-14 hover:scale-105 transition-all duration-300 backdrop-blur-sm"
                                style={{
                            ...
                            <FeatureCard
                                icon={
                                    <Heart
                                        className="h-6 w-6"
                                        style={{
                                            color: 'hsl(var(--landing-feature-icon-primary))',
                                        }}
                                    />
                                }
                            ...
                            <FeatureCard
                                icon={
                                    <Globe
                                        className="h-6 w-6"
                                        style={{
                                            color: 'hsl(var(--landing-feature-icon-secondary))',
                                        }}
                                    />
                                }
                            ...
                            <FeatureCard
                                icon={
                                    <Tv
                                        className="h-6 w-6"
                                        style={{
                                            color: 'hsl(var(--landing-feature-icon-tertiary))',
                                        }}
                                    />
                                }
