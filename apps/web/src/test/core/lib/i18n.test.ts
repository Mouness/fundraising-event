...
describe('i18n lib', () => {
    ...
    it('should sync locales', () => {
        ...
        expect(addResourceBundleSpy).toHaveBeenCalledWith('en', 'common', { test: 'value' }, true, true);
        expect(addResourceBundleSpy).toHaveBeenCalledWith('fr', 'common', { test: 'valeur' }, true, true);
    });
});
