...
describe('LandingPage', () => {
    ...
    it('renders footer information', () => {
        ...
        expect(screen.getByText('landing.footer.website')).toHaveAttribute(
            'href',
            'http://charity.com',
        )
        expect(screen.getByText('landing.footer.support')).toHaveAttribute(
            'href',
            'mailto:support@charity.com',
        )
    })
