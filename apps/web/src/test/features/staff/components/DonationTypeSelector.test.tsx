...
describe('DonationTypeSelector', () => {
    ...
    it('should apply active styling to selected type', () => {
        ...
        expect(cashButton).toHaveStyle({ backgroundColor: 'var(--staff-type-button-selected-bg)' });
        expect(checkButton).toHaveStyle({ backgroundColor: 'var(--staff-type-button-bg)' });
    });
