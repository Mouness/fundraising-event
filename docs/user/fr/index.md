...
Bienvenue dans le **Guide de l'Utilisateur de la Plateforme de Collecte de Fonds**. Ce document est conçu pour aider les administrateurs et membres de l'équipe à gérer efficacement les événements caritatifs, suivre les dons et engager la communauté.

## Mission & Philosophie

Cette plateforme a été construite avec un objectif unique : **permettre aux ONG et associations de se concentrer sur leur mission, pas sur la technologie.**
...
La plateforme est divisée en deux zones principales :

1.  **Interface Publique** : Accessible aux donateurs et au grand public.
...
Une fois connecté, vous serez accueilli par le **Tableau de Bord Global**.
...
- **[Événements](events.md)** : Créer et gérer des campagnes de collecte individuelles.
- **[Personnel](staff.md)** : Gérer les membres du staff global et les bénévoles.
- **[Paramètres](global_settings.md)** : [Configurer les défauts de l'organisation](global_settings.md) (Marque, Paiements, Communication).
- **[Dons](donations.md)** : Comprendre le flux de donation.
- **[Mode Live](live.md)** : Configurer l'écran de tableau de bord en direct.
