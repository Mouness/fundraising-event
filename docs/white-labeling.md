...
interface EventConfig {
  ...
  // Visual Theme
  theme?: {
    assets?: Record<string, string>;      // logo, backgroundLive, etc.
  ...
  // Localization
  locales?: {
    default: SupportedLocale;     // 'en' | 'fr' | 'de' | 'it'
...
> [!NOTE]
> The flat key format (`"donation.submit"`) is easier to manage in the database and admin UI than deeply nested objects.
